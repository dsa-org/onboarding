# 👥 DSA Labs — Team Tracker

**Purpose:**  
Centralized record of all active, former, and contractor team members across DSA Labs and its products (StatLink, ImpactCap, Walter Camp, etc.).  
Tracks onboarding/offboarding status, system access, and primary responsibilities.
...
| **Uzair** | Contractor | 2025-MM-DD | Active | GitHub | Depth Chart and Fan Vote development | Works with Zaman |
...
- **Full** → Slack, Email, GitHub, AWS, Database, Docs  
- **Partial** → Slack + GitHub only  
- **Removed** → All access revoked  
...
- Update this document **whenever someone joins or leaves**.
- Confirm **offboarding checklists** are complete before marking ✅.
- Perform a **quarterly audit** to verify access across Slack, GitHub, AWS, and Google Drive.
- Store archived team records under: `/Offboarding/[Name]_[MonthYear]/`.
